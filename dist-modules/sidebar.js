...
var _react4 = _interopRequireDefault2(_react3);

var _propTypes3 = require('prop-types');

var _propTypes4 = _interopRequireDefault2(_propTypes3);
...
var Sidebar = function (_Component2) {
  _inherits2(Sidebar, _Component2);

  function Sidebar(props) {
    _classCallCheck2(this, Sidebar);

    var _this2 = _possibleConstructorReturn2(this, (Sidebar.__proto__ || Object.getPrototypeOf(Sidebar)).call(this, props));
    ...
    _this2.overlayClicked = _this2.overlayClicked.bind(_this2);
    ...
    _this2.saveSidebarRef = _this2.saveSidebarRef.bind(_this2);
    return _this2;
  }
  ...
  _createClass2(Sidebar, [{
    ...
    value: function componentDidMount() {
      this.setState({
        dragSupported: (typeof window === 'undefined' ? 'undefined' : _typeof2(window)) === 'object' && 'ontouchstart' in window
      });
          ...
          value: function render() {
            ...
            if (useTouch) {
              if (this.props.open) {
                ...
                dragHandle = _react2.default.createElement('div', { style: this.props.externalStylesOnly ? '' : dragHandleStyle,
                  onTouchStart: this.onTouchStart, onTouchMove: this.onTouchMove,
                  onTouchEnd: this.onTouchEnd, onTouchCancel: this.onTouchEnd });
              }
            }

            var sideBar = this.props.sidebarElement === 'nav' ? _react2.default.createElement('nav', { className: this.props.sidebarClassName,
              id: this.props.sidebarId,
              style: sidebarStyle,
              ref: this.saveSidebarRef }, this.props.sidebar) : _react2.default.createElement('div', { className: this.props.sidebarClassName,
              id: this.props.sidebarId,
              style: sidebarStyle,
              ref: this.saveSidebarRef }, this.props.sidebar);

            return _react2.default.createElement('div', rootProps, sideBar, _react2.default.createElement('div', { className: this.props.overlayClassName,
              style: overlayStyle,
              role: 'presentation',
              tabIndex: '0',
              onClick: this.overlayClicked
            }), _react2.default.createElement('div', { className: this.props.contentClassName,
              style: contentStyle }, dragHandle, this.props.children));
          }
        }]);
    ...
    key: 'render',
    value: function render() {
      var sidebarStyle = _extends2({}, this.props.externalStylesOnly ? {} : defaultStyles.sidebar, this.props.styles.sidebar);
      var contentStyle = _extends2({}, this.props.externalStylesOnly ? {} : defaultStyles.content, this.props.styles.content);
      var overlayStyle = _extends2({}, this.props.externalStylesOnly ? {} : defaultStyles.overlay, this.props.styles.overlay);
      var useTouch = this.state.dragSupported && this.props.touch;
      var isTouching = this.isTouching();
      var rootProps = {
        className: this.props.rootClassName,
        style: _extends2({}, defaultStyles.root, this.props.styles.root),
        role: "navigation"
      };
      var dragHandle = void 0;
      ...
      if (useTouch) {
        if (this.props.open) {
          ...
          var dragHandleStyle = _extends2({}, defaultStyles.dragHandle, this.props.styles.dragHandle);
          dragHandleStyle.width = this.props.touchHandleWidth;
          ...
          dragHandle = _react4.default.createElement('div', { style: this.props.externalStylesOnly ? '' : dragHandleStyle,
            onTouchStart: this.onTouchStart, onTouchMove: this.onTouchMove,
            onTouchEnd: this.onTouchEnd, onTouchCancel: this.onTouchEnd });
        }
      }

      var sideBar = this.props.sidebarElement === 'nav' ? _react4.default.createElement(
        'nav',
      ...
      return _react4.default.createElement(
        ...
        rootProps,
        sideBar,
        _react4.default.createElement('div', { className: this.props.overlayClassName,
          style: overlayStyle,
          role: 'presentation',
          tabIndex: '0',
          onClick: this.overlayClicked
...
Sidebar.propTypes = {
  // main content to render
  children: _propTypes4.default.node.isRequired,

  // styles
  styles: _propTypes4.default.shape({
    root: _propTypes4.default.object,
    sidebar: _propTypes4.default.object,
    content: _propTypes4.default.object,
    overlay: _propTypes4.default.object,
    dragHandle: _propTypes4.default.object
  }),

  // Are styles loaded via an external source / stylesheet? If so, sets no styles on the component.
  externalStylesOnly: _propTypes4.default.bool,

  // root component optional class
  rootClassName: _propTypes4.default.string,

  // sidebar optional class
  sidebarClassName: _propTypes4.default.string,

  // content optional class
  contentClassName: _propTypes4.default.string,

  // overlay optional class
  overlayClassName: _propTypes4.default.string,

  // sidebar content to render
  sidebar: _propTypes4.default.node.isRequired,

  // boolean if sidebar should be docked
  docked: _propTypes4.default.bool,

  // optional element id
  sidebarId: _propTypes4.default.string,

  // boolean if sidebar should slide open
  open: _propTypes4.default.bool,

  // boolean if transitions should be disabled
  transitions: _propTypes4.default.bool,

  // boolean if touch gestures are enabled
  touch: _propTypes4.default.bool,

  // max distance from the edge we can start touching
  touchHandleWidth: _propTypes4.default.number,

  // Place the sidebar on the right
  pullRight: _propTypes4.default.bool,

  // Enable/Disable sidebar shadow
  shadow: _propTypes4.default.bool,

  // if an element other than 'div' is to be rendered as the sidebar root.
  sidebarElement: _propTypes4.default.string,

  // distance we have to drag the sidebar to toggle open state
  dragToggleDistance: _propTypes4.default.number,

  // callback called when the overlay is clicked
  onSetOpen: _propTypes4.default.func,

  // Intial sidebar width when page loads
  defaultSidebarWidth: _propTypes4.default.number
};
